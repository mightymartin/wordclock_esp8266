...
#if (!defined(WIRING_MATRIX_RLBT) && !defined(WIRING_MATRIX_LRBT))
#define WIRING_MATRIX_LRBT   1
#endif

#if (!defined(WIRING_DOTS_CLOCKWISE) && !defined(WIRING_DOTS_COUNTER_CLOCKWISE))
#define WIRING_DOTS_COUNTER_CLOCKWISE
#endif


#if WIRING_MATRIX_LRBT
...
#if WIRING_DOTS_COUNTER_CLOCKWISE
const uint8 dotsIndex[LED_DOTS] =           {
                                                111,110,113,112
                                            };
#endif

#if WIRING_MATRIX_RLBT
const uint8 matrixIndex[LED_MATRIX_ROWS][LED_MATRIX_COLS] =         {                              
...
#ifndef LAYOUT_MIKROCONTROLLER_NET
//#### Fill Words
